...
class Simulation:
    def __init__(self, N, alpha, kappa, U, args: ModelArgument):
        ...
        self.lambda_3_t = 2 * 0.4 * alpha
        self.psi0 = fock(N, 0)
        if U != 0:
            self.delta_b = -1 * (np.absolute(self.lambda_3_t) ** 2) / U # + 4 * U * alpha ** 2?
        else:
            self.delta_b = -10
    ...
    def evolve_lambda_3(self, init_state, is_short=False):
        ...
        final_result = mesolve(new_H, init_state, times2, [kappa * a], [], options={'nsteps': 80000, 'progress_bar': 'text'})
    ...
    # TODO: find place to put t1_len, t2_len, lambda_1_t4
    ...
    def optimize(self, 
        ...
        err = self.run_sim(lambda_1=init_lambda1, 
                           lambda_2=init_lambda2, 
        ...
        while num_loops < max_loops:
            ...
            if self.args.optim_lambda1:
                ...
                err_lambda_1_re = self.run_sim(
                    test_lambda_1_re,
                    lambda_2,
                    time_const)
                
                err_lambda_1_im = self.run_sim(
                    test_lambda_1_im,
                    lambda_2,
                    time_const)
            ...
            if self.args.optim_lambda2:
                ...
                err_lambda_2_re = self.run_sim(
                    lambda_1,
                    test_lambda_2_re,
                    time_const)

                err_lambda_2_im = self.run_sim(
                    lambda_1,
                    test_lambda_2_im,
                    time_const)
            ...
            new_err = self.run_sim(new_lambda_1, 
                                   new_lambda_2, 
                                   time_const)
